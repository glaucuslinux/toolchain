...
enum opt_code
{
  ...
  OPT_list = 1594,                           /* -list */
  OPT_m128bit_long_double = 1595,            /* -m128bit-long-double */
  OPT_m16 = 1596,                            /* -m16 */
  OPT_m32 = 1597,                            /* -m32 */
  OPT_m3dnow = 1598,                         /* -m3dnow */
  OPT_m3dnowa = 1599,                        /* -m3dnowa */
  OPT_m64 = 1600,                            /* -m64 */
  OPT_m80387 = 1601,                         /* -m80387 */
  OPT_m8bit_idiv = 1602,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1603,             /* -m96bit-long-double */
  OPT_mabi_ = 1604,                          /* -mabi= */
  OPT_mabm = 1605,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1606,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1607,                 /* -maddress-mode= */
  OPT_madx = 1608,                           /* -madx */
  OPT_maes = 1609,                           /* -maes */
  OPT_malign_data_ = 1610,                   /* -malign-data= */
  OPT_malign_double = 1611,                  /* -malign-double */
  OPT_malign_functions_ = 1612,              /* -malign-functions= */
  OPT_malign_jumps_ = 1613,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1614,                  /* -malign-loops= */
  OPT_malign_stringops = 1615,               /* -malign-stringops */
  OPT_mandroid = 1616,                       /* -mandroid */
  OPT_march_ = 1617,                         /* -march= */
  OPT_masm_ = 1618,                          /* -masm= */
  OPT_mavx = 1619,                           /* -mavx */
  OPT_mavx2 = 1620,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1621,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1622,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1623,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1624,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1625,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1626,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1627,                      /* -mavx512bw */
  OPT_mavx512cd = 1628,                      /* -mavx512cd */
  OPT_mavx512dq = 1629,                      /* -mavx512dq */
  OPT_mavx512er = 1630,                      /* -mavx512er */
  OPT_mavx512f = 1631,                       /* -mavx512f */
  OPT_mavx512ifma = 1632,                    /* -mavx512ifma */
  OPT_mavx512pf = 1633,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1634,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1635,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1636,                      /* -mavx512vl */
  OPT_mavx512vnni = 1637,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1638,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1639,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1640,                        /* -mbionic */
  OPT_mbmi = 1641,                           /* -mbmi */
  OPT_mbmi2 = 1642,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1643,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1644,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1645,                    /* -mcet-switch */
  OPT_mcld = 1646,                           /* -mcld */
  OPT_mcldemote = 1647,                      /* -mcldemote */
  OPT_mclflushopt = 1648,                    /* -mclflushopt */
  OPT_mclwb = 1649,                          /* -mclwb */
  OPT_mclzero = 1650,                        /* -mclzero */
  OPT_mcmodel_ = 1651,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1652, */                    /* -mcpu= */
  OPT_mcrc32 = 1653,                         /* -mcrc32 */
  OPT_mcx16 = 1654,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1655,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1656,            /* -mdump-tune-features */
  OPT_menqcmd = 1657,                        /* -menqcmd */
  OPT_mf16c = 1658,                          /* -mf16c */
  OPT_mfancy_math_387 = 1659,                /* -mfancy-math-387 */
  OPT_mfentry = 1660,                        /* -mfentry */
  OPT_mfentry_name_ = 1661,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1662,               /* -mfentry-section= */
  OPT_mfma = 1663,                           /* -mfma */
  OPT_mfma4 = 1664,                          /* -mfma4 */
  OPT_mforce_drap = 1665,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1666,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1667,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1668,                       /* -mfpmath= */
  OPT_mfsgsbase = 1669,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1670,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1671, */              /* -mfused-madd */
  OPT_mfxsr = 1672,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1673,             /* -mgeneral-regs-only */
  OPT_mgfni = 1674,                          /* -mgfni */
  OPT_mglibc = 1675,                         /* -mglibc */
  OPT_mhard_float = 1676,                    /* -mhard-float */
  OPT_mhle = 1677,                           /* -mhle */
  OPT_miamcu = 1678,                         /* -miamcu */
  OPT_mieee_fp = 1679,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1680,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1681,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1682,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1683,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1684,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1685,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1686, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1687,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1688,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1689,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1690,                /* -mlong-double-80 */
  OPT_mlwp = 1691,                           /* -mlwp */
  OPT_mlzcnt = 1692,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1693,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1694,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1695,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1696,                  /* -mmitigate-rop */
  OPT_mmmx = 1697,                           /* -mmmx */
  OPT_mmovbe = 1698,                         /* -mmovbe */
  OPT_mmovdir64b = 1699,                     /* -mmovdir64b */
  OPT_mmovdiri = 1700,                       /* -mmovdiri */
  OPT_mmpx = 1701,                           /* -mmpx */
  OPT_mms_bitfields = 1702,                  /* -mms-bitfields */
  OPT_mmusl = 1703,                          /* -mmusl */
  OPT_mmwaitx = 1704,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1705,            /* -mno-align-stringops */
  OPT_mno_default = 1706,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1707,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1708,                  /* -mno-push-args */
  OPT_mno_red_zone = 1709,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1710,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1711,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1712,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1713,                          /* -mpc32 */
  OPT_mpc64 = 1714,                          /* -mpc64 */
  OPT_mpc80 = 1715,                          /* -mpc80 */
  OPT_mpclmul = 1716,                        /* -mpclmul */
  OPT_mpcommit = 1717,                       /* -mpcommit */
  OPT_mpconfig = 1718,                       /* -mpconfig */
  OPT_mpku = 1719,                           /* -mpku */
  OPT_mpopcnt = 1720,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1721, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1722,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1723,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1724,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1725,                        /* -mprfchw */
  OPT_mptwrite = 1726,                       /* -mptwrite */
  OPT_mpush_args = 1727,                     /* -mpush-args */
  OPT_mrdpid = 1728,                         /* -mrdpid */
  OPT_mrdrnd = 1729,                         /* -mrdrnd */
  OPT_mrdseed = 1730,                        /* -mrdseed */
  OPT_mrecip = 1731,                         /* -mrecip */
  OPT_mrecip_ = 1732,                        /* -mrecip= */
  OPT_mrecord_mcount = 1733,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1734,                 /* -mrecord-return */
  OPT_mred_zone = 1735,                      /* -mred-zone */
  OPT_mregparm_ = 1736,                      /* -mregparm= */
  OPT_mrtd = 1737,                           /* -mrtd */
  OPT_mrtm = 1738,                           /* -mrtm */
  OPT_msahf = 1739,                          /* -msahf */
  OPT_msgx = 1740,                           /* -msgx */
  OPT_msha = 1741,                           /* -msha */
  OPT_mshstk = 1742,                         /* -mshstk */
  OPT_mskip_rax_setup = 1743,                /* -mskip-rax-setup */
  OPT_msoft_float = 1744,                    /* -msoft-float */
  OPT_msse = 1745,                           /* -msse */
  OPT_msse2 = 1746,                          /* -msse2 */
  OPT_msse2avx = 1747,                       /* -msse2avx */
  OPT_msse3 = 1748,                          /* -msse3 */
  OPT_msse4 = 1749,                          /* -msse4 */
  OPT_msse4_1 = 1750,                        /* -msse4.1 */
  OPT_msse4_2 = 1751,                        /* -msse4.2 */
  OPT_msse4a = 1752,                         /* -msse4a */
  /* OPT_msse5 = 1753, */                    /* -msse5 */
  OPT_msseregparm = 1754,                    /* -msseregparm */
  OPT_mssse3 = 1755,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1756,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1757, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1758,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1759, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1760,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1761,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1762,            /* -mstringop-strategy= */
  OPT_mstv = 1763,                           /* -mstv */
  OPT_mtbm = 1764,                           /* -mtbm */
  OPT_mtls_dialect_ = 1765,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1766,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1767,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1768,                         /* -mtune= */
  OPT_muclibc = 1769,                        /* -muclibc */
  OPT_mvaes = 1770,                          /* -mvaes */
  OPT_mveclibabi_ = 1771,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1772,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1773,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1774,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1775,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1776,                      /* -mwbnoinvd */
  OPT_mx32 = 1777,                           /* -mx32 */
  OPT_mxop = 1778,                           /* -mxop */
  OPT_mxsave = 1779,                         /* -mxsave */
  OPT_mxsavec = 1780,                        /* -mxsavec */
  OPT_mxsaveopt = 1781,                      /* -mxsaveopt */
  OPT_mxsaves = 1782,                        /* -mxsaves */
  OPT_n = 1783,                              /* -n */
  OPT_name_sort = 1784,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1785,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1786,              /* -no-integrated-cpp */
  OPT_no_pie = 1787,                         /* -no-pie */
  OPT_nocpp = 1788,                          /* -nocpp */
  OPT_nodefaultlibs = 1789,                  /* -nodefaultlibs */
  OPT_nolibc = 1790,                         /* -nolibc */
  OPT_nophoboslib = 1791,                    /* -nophoboslib */
  OPT_nostartfiles = 1792,                   /* -nostartfiles */
  OPT_nostdinc = 1793,                       /* -nostdinc */
  OPT_nostdinc__ = 1794,                     /* -nostdinc++ */
  OPT_nostdlib = 1795,                       /* -nostdlib */
  OPT_o = 1796,                              /* -o */
  OPT_objects = 1797,                        /* -objects */
  OPT_p = 1798,                              /* -p */
  OPT_pass_exit_codes = 1799,                /* -pass-exit-codes */
  /* OPT_pedantic = 1800, */                 /* -pedantic */
  OPT_pedantic_errors = 1801,                /* -pedantic-errors */
  OPT_pg = 1802,                             /* -pg */
  OPT_pie = 1803,                            /* -pie */
  OPT_pipe = 1804,                           /* -pipe */
  OPT_posix = 1805,                          /* -posix */
  OPT_print_file_name_ = 1806,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1807,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1808,          /* -print-multi-directory */
  OPT_print_multi_lib = 1809,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1810,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1811,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1812,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1813,               /* -print-prog-name= */
  OPT_print_search_dirs = 1814,              /* -print-search-dirs */
  OPT_print_sysroot = 1815,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1816,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1817,                    /* -print-value */
  OPT_profile = 1818,                        /* -profile */
  OPT_pthread = 1819,                        /* -pthread */
  OPT_quiet = 1820,                          /* -quiet */
  OPT_r = 1821,                              /* -r */
  OPT_rdynamic = 1822,                       /* -rdynamic */
  ...
  OPT_static_liblsan = 1839,                 /* -static-liblsan */
  OPT_static_libmpx = 1840,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1841,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1842,               /* -static-libphobos */
  OPT_static_libstdc__ = 1843,               /* -static-libstdc++ */
  OPT_static_libtsan = 1844,                 /* -static-libtsan */
  OPT_static_libubsan = 1845,                /* -static-libubsan */
  OPT_static_pie = 1846,                     /* -static-pie */
  /* OPT_std_c__03 = 1847, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1848, */                /* -std=c++0x */
  OPT_std_c__11 = 1849,                      /* -std=c++11 */
  OPT_std_c__14 = 1850,                      /* -std=c++14 */
  OPT_std_c__17 = 1851,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1852, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1853, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1854, */                /* -std=c++20 */
  OPT_std_c__2a = 1855,                      /* -std=c++2a */
  OPT_std_c__98 = 1856,                      /* -std=c++98 */
  OPT_std_c11 = 1857,                        /* -std=c11 */
  OPT_std_c17 = 1858,                        /* -std=c17 */
  /* OPT_std_c18 = 1859, */                  /* -std=c18 */
  /* OPT_std_c1x = 1860, */                  /* -std=c1x */
  OPT_std_c2x = 1861,                        /* -std=c2x */
  /* OPT_std_c89 = 1862, */                  /* -std=c89 */
  OPT_std_c90 = 1863,                        /* -std=c90 */
  OPT_std_c99 = 1864,                        /* -std=c99 */
  /* OPT_std_c9x = 1865, */                  /* -std=c9x */
  OPT_std_f2003 = 1866,                      /* -std=f2003 */
  OPT_std_f2008 = 1867,                      /* -std=f2008 */
  OPT_std_f2008ts = 1868,                    /* -std=f2008ts */
  OPT_std_f2018 = 1869,                      /* -std=f2018 */
  OPT_std_f95 = 1870,                        /* -std=f95 */
  OPT_std_gnu = 1871,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1872, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1873, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1874,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1875,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1876,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1877, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1878, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1879, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1880,                    /* -std=gnu++2a */
  ...
  OPT_time = 1902,                           /* -time */
  OPT_time_ = 1903,                          /* -time= */
  OPT_tno_android_cc = 1904,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1905,                 /* -tno-android-ld */
  OPT_traditional = 1906,                    /* -traditional */
  OPT_traditional_cpp = 1907,                /* -traditional-cpp */
  OPT_tree_stats = 1908,                     /* -tree-stats */
  OPT_trigraphs = 1909,                      /* -trigraphs */
  OPT_type_stats = 1910,                     /* -type-stats */
  OPT_u = 1911,                              /* -u */
  OPT_undef = 1912,                          /* -undef */
  OPT_v = 1913,                              /* -v */
  OPT_version = 1914,                        /* -version */
  OPT_w = 1915,                              /* -w */
  OPT_wrapper = 1916,                        /* -wrapper */
  OPT_x = 1917,                              /* -x */
  OPT_z = 1918,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
